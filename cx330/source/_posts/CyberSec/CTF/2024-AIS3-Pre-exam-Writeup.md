...
(這次的參賽紀錄我也有放在個人網站上，等 Writeup 截止當天才會公開，可以透過[這個連結](https://cx330.tw/CyberSec/CTF/2024-AIS3-Pre-exam-Writeup/)訪問)
...
既然已經知道了他是 Gcode，我們就趕快來找一個線上的 Viewer 來看看他生做圓還是扁吧！我使用的網站是[這個](https://ncviewer.com/)。把那串代碼放上去後，就點一下圖中的 Plot 來看看！
